...
import de.fhpotsdam.unfolding.providers.EsriProvider.WorldGrayCanvas;
...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		this.background(0, 200, 0);
		
		// Select a map provider
		AbstractMapProvider provider = new Google.GoogleTerrainProvider();
		WorldGrayCanvas esriProvider = new EsriProvider.WorldGrayCanvas();
		// Set a zoom level
		int zoomLevel = 10;
		...
		map2 = new UnfoldingMap(this, 425, 50, 350, 500, esriProvider);
		
		//map2.zoomAndPanTo(zoomLevel, new Location(51f,-114f));
